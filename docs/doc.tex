...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c}
        \hline
        & Shlédnuté př. & Relevantní př. & Irrelevantní př. & Shlédnuté re. & Relevantní re. & Irrelevantní re. \\
        \hline
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\linewidth]{Shlédnuté_příspěvky_za_den.png}
